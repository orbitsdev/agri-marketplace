<div>
    ...
    <form class="mt-12 lg:grid lg:grid-cols-12 lg:items-start lg:gap-x-12 xl:gap-x-16">
      <section aria-labelledby="cart-heading" class="lg:col-span-7 required:">
        ...
        <ul role="list" class="divide-y divide-gray-200 border-b border-t border-gray-200 relative">
            <div
            wire:loading.flex
            wire:target="toggleSelect, updateQuantity, removeItem"
            ...
            <div class="flex flex-col items-center">
                <!-- Spinner -->
                <div class="animate-spin rounded-full h-10 w-10 border-t-4 border-blue-500 border-opacity-75 border-b-4 border-gray-300"></div>
                <!-- Text -->
    ...
    <li class="flex py-6 sm:py-10 ">
        ...
        <!-- Product Image -->
        <div class="shrink-0">
            <img src="{{ $item->product->getImage() }}" alt="{{ $item->product->product_name }}" class="size-24 rounded-md object-cover sm:size-48">
        </div>
        ...
        <div class="ml-4 flex flex-1 flex-col justify-between sm:ml-6">
            <div class="relative pr-9 sm:grid sm:grid-cols-2 sm:gap-x-6 sm:pr-0">
                <div>
                    ...
                    <p class="mt-1 text-sm font-medium text-gray-900">₱{{ number_format($item->price_per_unit, 2) }}</p>
                </div>
...
<li class="py-6 sm:py-10 text-center">
    <div class="flex flex-col items-center space-y-4">
        ...
        <p class="text-gray-500">Looks like you haven’t added any items yet. Explore our collection and find something you like!</p>
        <a
      ...
      <section aria-labelledby="summary-heading" class="mt-16 rounded-lg bg-gray-50 px-4 py-6 sm:p-6 lg:col-span-5 lg:mt-0 lg:p-8">
        ...
        <dl class="mt-6 space-y-4">
            ...
            <div class="flex items-center justify-between border-t border-gray-200 pt-4">
                ...
                <dd class="text-sm font-medium text-gray-900">₱{{ number_format($totalSelectedValue, 2) }}</dd>
            </div>
        </dl>
